...
### Corporeal Health Solutions, Chennai — Full Stack Development Intern | Jun 2025 - Jul 2025
...
### Cresent Techno Soft, Bangalore — Web Development Intern | Dec 2024 - Jan 2025
...
- Built a **responsive restaurant ordering website** with login, menu management, and order tracking
- Developed **backend functionalities** using Node.js, Express.js, and MongoDB
...
```
  System Design    ->  HLD, LLD, Scalability Patterns, Load Balancing
  ...
  React Native     ->  Animations, Native Modules, Performance Tuning
```
